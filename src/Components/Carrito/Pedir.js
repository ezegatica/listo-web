            ...
            <div>
                ...
                <div id="modal1" className="modal">
                    <div className="modal-content">
                        ...
                        <p><b>Horario de entrega: </b> <span className="inline input-field"><input type="text" className="timepicker" placeholder="Haz click para seleccionar tu horario de entrega" onChange={this.setHoraEntrega}/></span></p>

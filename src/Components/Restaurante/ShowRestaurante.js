    ...
    return (
        <div className="card z-depth-0 proyect-summary grey lighten-3">
            <div className="card-content grey-text text-darken-3 lista-proyectos row">
                <div className="col s3 m3 l2 xl1">
                    <img src={restaurant.info.foto || 'https://firebasestorage.googleapis.com/v0/b/prueba-proyecto-tic.appspot.com/o/user.png?alt=media'} alt={"IMG"} className=" circle z-depth-3 imagen-lista" /> <br />
                </div>
                <div className="col s9 m9 l10 xl11">
